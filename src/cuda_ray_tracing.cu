...
__global__ void Cuda::Cuda_canvas_intersect(SimpleColor* d_canvas, Scene& scene, Sphere* spheres, size_t spheres_size, double double_max, Light* lights, size_t lights_size) {
